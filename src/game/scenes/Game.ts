...
import { QuickFallDetectionSystem } from "../logic/boomerang/systems/QuickFallDetectionSystem.ts";
...
import { ProjectileSystem } from "../logic/projectile/systems/ProjectileSystem.ts";
...
import { UpgradeSystem } from "../logic/upgrades/systems/UpgradeSystem.ts";
import {
    WaveConductorSystem,
    ActiveConductorState,
} from "../logic/wave-conductor/WaveConductorSystem.ts";
import { WaveEndDetectorSystem } from "../logic/wave-conductor/WaveEndDetectorSystem.ts";
import { registerForResize } from "../utils/registerForResize.ts";
import { CaughtProjectileShootingSystem } from "../logic/upgrades/systems/CaughtProjectileShootingSystem.ts";
import { CaughtProjectileExplosionSystem } from "../logic/upgrades/systems/CaughtProjectileExplosionSystem.ts";
import { SpiritExplosionDamageSystem } from "../logic/spirits/systems/SpiritExplosionDamageSystem.ts";
import { UpgradeShortlistSystem } from "../logic/upgrades/systems/UpgradeShortlistSystem.ts";
...
export class Game extends Scene {
    ...
    create() {
        ...
        this.ecs.addSystem(new QuickFallDetectionSystem());
        ...
        this.ecs.addSystem(new UpgradeSystem());
        this.ecs.addSystem(new CaughtProjectileShootingSystem());
        this.ecs.addSystem(new ProjectileSystem());
        this.ecs.addSystem(new CaughtProjectileExplosionSystem());
        this.ecs.addSystem(new SpiritExplosionDamageSystem());
        this.ecs.addSystem(new UpgradeShortlistSystem());
