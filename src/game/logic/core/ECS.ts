...
export abstract class System {
    ...
    /**
     * destroy() is called when the System is removed from the ECS. It
     * should clean up any resources, listeners, etc. that it has.
     */
 ...
 */
export class ECS {
    public world: Entity; // This is a placeholder for the world entity, if needed.
    // Main state
    ...
    /**
     * Removes a System from the ECS. This will stop it from being
     * updated, and it will no longer track Entities.
     */
    ...
    private checkES(entity: Entity, system: System): void {
        if (system.componentsRequired.size == 0) {
            // This system has no components, so it runs on nothing - a signal or event system.
            return;
        }
